  ...
  const handleSubmit = async (values: LoginFormValues) => {
    try {
      ...
      if (success) {
        ...
        console.warn("Login failed: invalid credentials or role");
      }
    } catch (error) {
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <SignupBranding
            title="Welcome"
            highlightText="Back"
            description=" Sign in to continue your journey of creating exceptional digital
              experiences."
            showStats={true}
          />
                    ...
                    <div className="form-element flex items-center justify-between">
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input
                          ...
                          onChange={handleChange}
                          className="w-5 h-5 rounded border-2 border-[var(--hero-image)]/30 bg-[var(--background)]/50 checked:bg-[var(--hero-image)] checked:border-[var(--hero-image)] transition-all cursor-pointer"
                        />
                      ...
                      <Link
                        ...
                        className="text-sm font-semibold text-[var(--hero-image)] hover:text-purple-500 transition-colors"
                      >
                        Forgot Password?
                      </Link>
                    </div>
